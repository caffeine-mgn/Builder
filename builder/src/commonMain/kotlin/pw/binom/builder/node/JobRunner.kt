...
//
//class ConnectionPublicator(val con: WebSocketConnection) {
...
//
//    init {
//        ProcessExecutor.runBash(
//                buildNumber = buildNumber,
//                dir = dir,
//                bashPath = bashPath,
//                output = object : ProcessExecutor.Output {
//                    override fun std(text: String) {
//                        connection.write(MessageType.TEXT) { out ->
//
//                        }
//                    }
//
...
//
//
//    fun start(connection: WebSocketConnection) {
//        runnerThread.start()
//    }
//
//    fun build() {
