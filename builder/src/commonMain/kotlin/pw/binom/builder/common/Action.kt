...
//    this.polymorphic(Action::class, Action::class, Action.serializer())
//}
//
//private val actionJsonSerialization = Json {
...
//sealed class Action {
//
//    fun toJson(): String = actionJsonSerialization.encodeToString(serializer(), this)
//
//    companion object {
//        fun toAction(json: String): Action = actionJsonSerialization.decodeFromString(serializer(), json)
//    }
//
